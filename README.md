...
1. **Python Pandas: Tratando e Analisando Dados**: Carga Horária: 12 Horas. Alura (2024).
2. **Análise de Experimentos: Testes, Mapas de Cores e Análise de Dados**: Carga Horária: 6 Horas. Alura (2024).
3. **Formação Estatística com Python**: Carga Horária: 71 Horas. Alura (2024).
4. **Docker: Criando e Gerenciando Containers**: Carga Horária: 10 Horas. Alura (2024).
5. **Regressão Linear: Técnicas Avançadas de Modelagem**: Carga Horária: 5 Horas. Alura (2024).
6. **Regressão Linear: Testando Relações e Prevendo Resultados**: Carga Horária: 12 Horas. Alura (2023).
7. **Estatística com Python: Correlação e Regressão**: Carga Horária: 10 Horas. Alura (2023).
8. **Data Science: Testes Estatísticos com Python**: Carga Horária: 6 Horas. Alura (2023).
9. **Estatística com Python: Testes de Hipóteses**: Carga Horária: 10 Horas. Alura (2023).
10. **Estatística com Python: Probabilidade e Amostragem**: Carga Horária: 10 Horas. Alura (2023).
11. **Estatística com Python: Frequências e Medidas**: Carga Horária: 10 Horas. Alura (2023).
12. **ChatGPT: Otimizando a Qualidade dos Resultados**: Carga Horária: 8 Horas. Alura (2023).
13. **Formação Machine Learning**: Carga Horária: 76 Horas. Alura (2023).
14. **Machine Learning Parte 2: Otimização com Exploração Aleatória**: Carga Horária: 8 Horas. Alura (2023).
15. **Machine Learning Parte 1: Otimização de Modelos através de Hiperparâmetros**: Carga Horária: 9 Horas. Alura (2023).
16. **Classificação: Validação de Modelos e Métricas de Avaliação**: Carga Horária: 8 Horas. Alura (2023).
17. **Machine Learning: Validação de Modelos**: Carga Horária: 8 Horas. Alura (2023).
18. **Clustering Aplicado: Recomendando Músicas com K-Means**: Carga Horária: 10 Horas. Alura (2023).
19. **Clustering: Extraindo Padrões de Dados**: Carga Horária: 9 Horas. Alura (2023).
20. **Formação Data Analysis com Google Sheets**: Carga Horária: 35 Horas. Alura (2023).
21. **Data Visualization: Técnicas de Visualização com Google Sheets**: Carga Horária: 8 Horas. Alura (2023).
22. **Data Analysis: Estatística com Google Sheets**: Carga Horária: 8 Horas. Alura (2023).
23. **Data Analysis: Previsões com Google Sheets**: Carga Horária: 8 Horas. Alura (2023).
24. **Machine Learning: Lidando com Dados de Muitas Dimensões**: Carga Horária: 12 Horas. Alura (2022).
25. **Machine Learning: Classificação por trás dos Panos**: Carga Horária: 10 Horas. Alura (2022).
26. **Machine Learning: Classificação com Sklearn**: Carga Horária: 8 Horas. Alura (2022).
27. **Data Analysis: Google Sheets**: Carga Horária: 6 Horas. Alura (2022).
28. **Formação Google BigQuery e Data Studio**: Carga Horária: 126 Horas. Alura (2022).
29. **Google BigQuery e Data Studio: Projeto Final**: Carga Horária: 20 Horas. Alura (2022).
30. **Acesso ao BigQuery: Manipulação Programático Linguagens**: Carga Horária: 12 Horas. Alura (2022).
31. **BigQuery: Manipulação de Dados**: Carga Horária: 14 Horas. Alura (2022).
32. **Google Data Studio: Parâmetros e BigQuery**: Carga Horária: 14 Horas. Alura (2022).
33. **Google Data Studio: Filtros e Funções**: Carga Horária: 14 Horas. Alura (2022).
34. **Google Data Studio: Acessando o MySQL**: Carga Horária: 14 Horas. Alura (2022).
35. **Google Data Studio: Introdução à Ferramenta**: Carga Horária: 10 Horas. Alura (2022).
36. **BigQuery: Funções do BigQuery**: Carga Horária: 16 Horas. Alura (2022).
37. **BigQuery: o Banco de Dados da Google para Big Data**: Carga Horária: 12 Horas. Alura (2022).
38. **Python Fundamentos para Análise de Dados**: Carga Horária: 60 Horas. Data Science Academy (2022).
39. **Big Data Fundamentos**: Carga Horária: 12 Horas. Data Science Acadademy (2022).
40. **Inteligência Artificial Fundamentos**: Carga Horária: 8 Horas. Data Science Academy (2022).
41. **Introdução à Ciência de Dados**: Carga Horária: 12 Horas. Data Science Academy (2021).
42. **Computer Vision**: Carga Horária: 4 Horas. Kaggle Plataform (2021).
43. **Natural Language Processing**: Carga Horária: 3 Horas. Kaggle Plataform (2021).
44. **Intro to Deep Learning**: Carga Horária: 4 Horas. Kaggle Plataform (2021).
45. **Intermediate Machine Learning**: Carga Horária: 4 Horas. Kaggle Plataform (2021).
46. **Intro to Machine Learning**: Carga Horária: 3 Horas. Kaggle Plataform (2021).
47. **Feature Engineering**: Carga Horária: 5 Horas. Kaggle Plataform (2021).
48. **Data Cleaning**: Carga Horária: 4 Horas. Kaggle Plataform (2021).
49. **Data Visualization**: Carga Horária: 4 Horas. Kaggle Plataform (2021).
50. **Time Series**: Carga Horária: 5 Horas. Kaggle Plataform (2021).
51. **Pandas**: Carga Horária: 4 Horas. Kaggle Plataform (2021).
52. **Python**: Carga Horária: 5 Horas. Kaggle Plataform (2021).
53. **Advanced SQL**: Carga Horária: 4 Horas. Kaggle Plataform (2021).
54. **Intro SQL**: Carga Horária: 3 Horas. Kaggle Plataform (2021).
55. **SQL Completo**: Carga Horária: 12 Horas. Udemy Academy (2021).
56. **Power BI Completo**: Carga Horária: 9 Horas. Udemy Academy (2021).
57. **Comandos e Acionamentos Elétricos**: Carga Horária: 9 Horas. Udemy Academy (2021).
58. **Técnicas de Parametrização de Inversor de Frequência**: Carga Horária: 48 Horas. SENAI-PA (2016).
59. **Auxiliar de Eletrônica**: Carga Horária: 160 Horas. SENAI-PA (2015).
60. **Língua Inglesa**: Carga Horária: 720 Horas. Escola de Idiomas Aslan (2010).
